					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="insert/insertpelanggan.php" method="POST" id="demo-form2"
										data-parsley-validate class="form-horizontal form-label-left">

										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="jenis">Nama
												Pelanggan <span class="required"></span>
											</label>
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="jenis" name="nama" required class="form-control">
											</div>
										</div>
										<div class="item form-group">
											<label for="harga"
											...
											<div class="col-md-6 col-sm-6 ">
												<input id="harga" class="form-control" type="text" name="alamat"
													required>
											</div>
										</div>

										<<div class="item form-group" style="margin-top: -18px;">
											<label for="stok" class="col-form-label col-md-3 col-sm-3 label-align">No
												Telp</label>
											<div class="col-md-6 col-sm-6 ">
												<input id="stok" class="form-control" type="text" name="no" required>
											</div>
								</div>
